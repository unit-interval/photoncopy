...
$tables = array(
	...
	'order' => array(
		...
		'row' => array(
			"default, 1, 1, 2, 0, 1, 1, 2, 1, 7, 0.3, '-', 'test1'",
			"default, 1, 1, 1, 2, 2, 1, 1, 2, 5, 1.2, '-', 'test2'",
			"default, 1, 2, 0, 1, 1, 2, 1, 3, 3, 0.5, '-', 'test3'",
			"default, 2, 2, 0, 3, 2, 2, 1, 1, 5, 0.6, '-', 'test4'",
			"default, 2, 3, 2, 0, 1, 1, 2, 4, 5, 2.7, '-', 'test5'",
			"default, 3, 1, 1, 1, 1, 2, 2, 1, 3, 0.9, '-', 'test6'",
			"default, 1, 1, 2, 0, 1, 1, 2, 1, 7, 0.3, '-', 'test1'",
			"default, 1, 1, 1, 2, 2, 1, 1, 2, 5, 1.2, '-', 'test2'",
			"default, 1, 2, 0, 1, 1, 2, 1, 3, 3, 0.5, '-', 'test3'",
			"default, 2, 2, 0, 3, 2, 2, 1, 1, 5, 0.6, '-', 'test4'",
			"default, 2, 3, 2, 0, 1, 1, 2, 4, 5, 2.7, '-', 'test5'",
			"default, 1, 1, 2, 0, 1, 1, 2, 1, 7, 0.3, '-', 'test1'",
			"default, 1, 1, 1, 0, 2, 1, 1, 2, 5, 1.2, '-', 'test2'",
			"default, 1, 2, 0, 0, 1, 2, 1, 3, 3, 0.5, '-', 'test3'",
			"default, 2, 2, 0, 0, 2, 2, 1, 1, 5, 0.6, '-', 'test4'",
			"default, 2, 3, 2, 0, 1, 1, 2, 4, 5, 2.7, '-', 'test5'",
),
),
	'partner' => array(
