...
//		'index' => "ALTER TABLE `devel_pq`.`credit` ADD UNIQUE `id-pid` ( `id` , `pid` )",
	...
	'order' => array(
		...
		'row' => array(
			"default, 1, 1, 2, 1, 1, 2, 1, 7, 7, 1, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test1'",
			"default, 1, 1, 1, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 2, 0, 1, 2, 1, 3, 3, 3, 3, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test3'",
			"default, 2, 2, 0, 2, 2, 1, 1, 5, 5, 1, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test4'",
			"default, 2, 3, 2, 1, 1, 2, 4, 5, 5, 4, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test5'",
			"default, 3, 1, 1, 1, 2, 2, 1, 3, 3, 1, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test6'",
			"default, 1, 1, 2, 1, 1, 2, 1, 7, 7, 1, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test1'",
			"default, 1, 1, 1, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 2, 0, 1, 2, 1, 3, 3, 3, 3, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test3'",
			"default, 2, 2, 0, 2, 2, 1, 1, 5, 5, 1, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test4'",
			...
			"default, 2, 2, 0, 2, 2, 1, 1, 5, 5, 1, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test4'",
			"default, 2, 3, 2, 1, 1, 2, 4, 5, 5, 4, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test5'",
			"default, 1, 1, 3, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 0, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 5, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 4, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 3, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 2, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 1, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
			"default, 1, 1, 0, 2, 1, 1, 2, 5, 5, 2, 0, 0, 'abc.pdf', '-', default, default, default, default, 'test2'",
		),
	),
