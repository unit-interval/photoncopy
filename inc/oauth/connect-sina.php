<?php
/*
 * 本文件提供了关于连接新浪微博帐号的相关程序逻辑，
 * OAuth 和 API 访问基于新浪微博提供的 PHP SDK。
 * 光子复制 
 */
 
define( "WB_AKEY" , '1515110245' );
define( "WB_SKEY" , 'bb1c7d7a0e39162c46fc5a3ca905a64a' );
define( "WB_CB" , 'http://testing.photoncopy.com/xhr/auth-login-sina.php' );
